...
import { type MarketplaceListing } from "@/lib/marketplace-transformers";
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-1 flex-col gap-4 p-6">
            ...
            <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
              ...
              <span>
                {listing.location} &middot; Listed {formatDate(listing.postedAt)}
              </span>
            </div>
          ...
          <Tabs defaultValue="comments">
            ...
            <TabsContent value="negotiations">
              <div className="flex flex-col gap-4">
                ...
                {/* TODO: Add offer thread component */}
                {listing.negotiations.map((neg) => (
                  <div key={neg.id} className="p-4 rounded-lg border">
                    <p className="text-sm">
                      Negotiation from {neg.buyerName} - Status: {neg.status}
                    </p>
                  </div>
                ))}
              </div>
